...
var app = {
    ...
    startSession: function () {
        console.log('start');
        var exercises = ['plank','side_plank'];
        for(var i=0; i<exercises.length; i++){        
            window.setTimeout(showImage(exercises[i]), 000);    
        }
    }
};
...
function showImage (exerciseName) {
    sessionDiv.innerHTML = '<img src="img/'+ exerciseName +'.jpg"/>';    
}